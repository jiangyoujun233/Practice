package com.nora.website.constant;

public class TourismConstant {
    ...
    public static final String MESSAGE_SYSTEM_ERROR_LOGIN_NOT_UNIQUE = "系统错误：登录名不唯一！";
    public static final String ATTR_NAME_PAGE_INFO = "pageInfo";
    public static final String MESSAGE_EDITPW_FILED = "修改后的密码不能与原密码重复！";
}
